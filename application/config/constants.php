...
define('BACKEND_TITLE','你的強棒應援團 後台');

//基本設定
define('projectName', 'mli_baseball'); //專案名
...
define('fans_page'      ,is_https.'://www.facebook.com/MLI.TW');     //mr.6
define('fans_page_id'   ,'434719119919301'); //mr.6
